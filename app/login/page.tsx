  ...
  return (
    <main className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
      <div className="bg-white border border-gray-300 rounded-lg p-6 w-full max-w-sm">
        <div className="w-11 h-11 bg-blue-600 rounded-md flex items-center justify-center mb-5">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
            <path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2v-4M9 21H5a2 2 0 0 1-2-2v-4m0 0h18"/>
          </svg>
        </div>

        <h1 className="text-lg font-semibold text-gray-900 mb-1">Base de Dados da Magayver Injecar</h1>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-3">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm outline-none focus:border-blue-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-blue-600 text-white rounded py-3 text-sm font-semibold hover:bg-blue-700 disabled:opacity-50 transition-colors mt-1"
          >
